  ...
  (newValue) => {
    if (newValue) {
      series.value = [
        {
          name: "Opravy",
          data: newValue.months.map((item) => item.invoices.issued.repairs.count),
        },
        {
          name: "Výměny",
          data: newValue.months.map((item) => item.invoices.issued.replacements.count),
        },
        {
          name: "Ostatní",
          data: newValue.months.map((item) => item.invoices.issued.others.count),
        },
      ];
    }
  }
